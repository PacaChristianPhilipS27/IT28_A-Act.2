...
async function fetchAndDisplayProducts() {
    try {
        ...
        const productList = document.getElementById('doy');
        const productListContainer = document.createElement('div');
        productListContainer.classList.add('row'); // Add Bootstrap
        ...
        data.forEach(product => {
            ...
            image.classList.add('card-img-top'); // adding card
            ...
            card.appendChild(image); // Add image
